...
class User_Logic {
    static get_user_roles(){
        return [
            {
                value:Type.USER_ROLE_SUPER_ADMIN,
                label:Title.USER_ROLE_SUPER_ADMIN,
                title:Title.USER_ROLE_SUPER_ADMIN
            },

            {
                value:Type.USER_ROLE_ADMIN,
                label:Title.USER_ROLE_ADMIN,
                title:Title.USER_ROLE_ADMIN
            },
            {
                value:Type.USER_ROLE_MANAGER,
                label:Type.TITLE_USER_ROLE_MANAGER,
                title:Type.TITLE_USER_ROLE_MANAGER
            },
            {
                value:Type.USER_ROLE_USER,
                label:Title.USER_ROLE_USER,
                title:Title.USER_ROLE_USER
            },
            {
                value:Type.USER_ROLE_GUEST,
                label:Title.USER_ROLE_GUEST,
                title:Title.USER_ROLE_GUEST
            },
        ];
    };
    static get_user_role_by_type(type){
        ...
        if(item_match){
            ...
            return {value:Type.USER_ROLE_GUEST,label:Title.USER_ROLE_GUEST,title:Title.USER_ROLE_GUEST};
        }
    };
    ...
    static get_guest(){
        return Data_Logic.get(Table.USER,0,{data:{is_guest:true,title_url:'guest',first_name:'Guest',last_name:'User',email:'guest@email.com',title:"Guest",country:"United States"}});
    }
    static get_request_user(req){
        if(!req || !req.session.user){
            let user=Data_Logic.get(Table.USER,Num.get_id(9999999),{data:{is_guest:true}});
    ...
    static get_test = () =>{
        let data = Data_Logic.get(Table.USER,0);
